...
<body>
    ...
    <script>
        ...
        function calculate() {
            ...
            els.flowResult.textContent = pumpFlow.toFixed(4);
            els.filmResult.textContent = filmThicknessVal.toFixed(4);
            els.resultBox.style.display = 'block';

            saveRecord({
                ...data,
                pumpFlow: pumpFlow.toFixed(4),
                filmThickness: filmThicknessVal.toFixed(4),
